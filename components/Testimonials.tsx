...
export default function Testimonials() {
  ...
  const renderStars = (rating: number) => (
    <div className="flex gap-1 mb-4">
      {[1, 2, 3, 4, 5].map((star) => (
        <Star
          key={star}
          className={`w-5 h-5 ${star <= rating ? 'fill-[#D97706] text-[#D97706]' : 'text-gray-300'
            }`}
        />
      ))}
    </div>
  ...
  return (
    <section
      ref={sectionRef}
      className="relative py-20 md:py-28 bg-gradient-to-br from-[#D97706]/10 via-white to-[#D97706]/20 overflow-hidden"
    >
      <div className="absolute top-10 left-10 w-72 h-72 bg-[#D97706] rounded-full mix-blend-multiply filter blur-3xl opacity-20 animate-blob"></div>
      <div className="absolute top-10 right-10 w-72 h-72 bg-[#D97706] rounded-full mix-blend-multiply filter blur-3xl opacity-20 animate-blob animation-delay-2000"></div>
      <div className="absolute bottom-10 left-1/2 w-72 h-72 bg-[#D97706] rounded-full mix-blend-multiply filter blur-3xl opacity-20 animate-blob animation-delay-4000"></div>
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className={`text-center mb-12 transition-all duration-1000 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'
          ...
          <Button 
            ...
            className="bg-[#D97706] hover:bg-orange-900 text-white px-8 py-6 text-lg"
          >
        ...
        <div className={`relative h-80 rounded-3xl overflow-hidden mb-16 shadow-2xl transition-all duration-1000 ${isVisible ? 'opacity-100 scale-100' : 'opacity-0 scale-95'
          ...
          <div className="absolute inset-0 bg-gradient-to-r from-[#D97706]/60 via-[#D97706]/30 to-transparent flex items-center">
            ...
            <div className="max-w-xl px-12">
              ...
              <div className="flex items-center gap-6">
                ...
                <div className="flex -space-x-3">
                  {[1, 2, 3, 4].map((i) => (
                    <div key={i} className="w-12 h-12 rounded-full bg-[#D97706] border-4 border-white flex items-center justify-center">
