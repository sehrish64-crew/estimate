            ...
            <div>
              ...
              <div className="space-y-3">
                ...
                <div className="flex justify-between">
                  ...
                  <span className={`font-semibold ${result.history.accidents === 0 ? 'text-green-600' : 'text-orange-600'}`}>
                ...
                <div className="flex justify-between">
                  ...
                  <span className={`font-semibold ${result.history.floodDamage ? 'text-orange-600' : 'text-green-600'}`}>
                    {result.history.floodDamage ? 'Yes' : 'No'}
                  </span>
                </div>
                <div className="flex justify-between">
                  <span className="text-gray-600">Fire Damage:</span>
                  <span className={`font-semibold ${result.history.fireDamage ? 'text-orange-600' : 'text-green-600'}`}>
