...
export default function Footer() {
  ...
  return (
    <footer className="relative overflow-hidden text-white bg-gradient-to-b from-black via-[#120000] to-black">
      ...
      {/* glow */}
      <div className="absolute top-0 left-0 w-[500px] h-[500px] bg-[#D97706]/30 rounded-full blur-[120px]" />
      <div className="absolute bottom-0 right-0 w-[500px] h-[500px] bg-[#D97706]/20 rounded-full blur-[140px]" />
      ...
      <div className="relative max-w-7xl mx-auto px-6 py-12">
        ...
        <div className="border-b border-white/10 pb-6 text-center">
          <p className="text-[11px] sm:text-xs md:text-sm text-white/70 leading-relaxed">
           ...
           All Rights Reserved. {new Date().getFullYear()} © Vehicle Health Estimate. {''}
            </span>

            <Link href="/terms" className="text-[#ccc] hover:text-orange-400 transition">
             <u> Terms & Conditions</u>
            </Link>
            {' , '}
            <Link href="/privacy" className="text-[#ccc] hover:text-orange-400 transition">
             <u> Privacy Policy</u>
            </Link>
            {' , '}
            <Link href="/refund-policy" className="text-[#ccc] hover:text-orange-400 transition">
             <u> Refund Policy</u>
            </Link>
            ...
            <span className="block mt-1 text-white/90">
              Phone: <a href="tel:+447555979712" className="text-[#ccc] hover:text-orange-400 transition">+44 7555 979712</a>
            ...
            <span className="block mt-2">
              <span className="text-white/90">Email: Info@vehiclehealthestimate.com</span>
            </span>
          </p>
        </div>
      ...
      <div className="h-[2px] w-full bg-gradient-to-r from-transparent via-[#D97706] to-transparent" />
    </footer>
  )
}
