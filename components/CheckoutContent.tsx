    ...
    <div className="min-h-screen bg-gradient-to-b from-gray-50 to-gray-100">
      ...
      <div className="bg-white border-b border-gray-200">
        <div className="max-w-4xl mx-auto px-3 sm:px-6 py-3 sm:py-6">
          <button
            onClick={() => router.back()}
            className="flex items-center gap-2 text-orange-700 hover:text-orange-800 font-medium mb-2 sm:mb-4"
          >
          ...
          <div className="col-span-1 lg:col-span-2 p-2 sm:p-4 bg-gray-50 border border-gray-200 rounded-lg">
            ...
            <div className="py-3 sm:py-4">
              <div className="flex justify-between items-center gap-2">
                ...
                <span className="text-xl sm:text-2xl font-bold text-orange-700 text-right">
                  {formatCurrency(formData.amount, formData.currency)}
                </span>
              </div>
            </div>
