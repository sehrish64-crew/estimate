...
export default function VinChecker() {
  ...
  return (
    <section
      ref={sectionRef}
      className="relative py-16 md:py-20 px-4 bg-gradient-to-br from-[#D97706]/10 via-white to-[#D97706]/5 overflow-hidden"
    >
      <div className="max-w-6xl mx-auto">

        <div
          className={`relative bg-gradient-to-br from-[#D97706] via-[#EA580C] to-[#B45309] rounded-3xl overflow-hidden shadow-2xl transform transition-all duration-1000 ${
            isVisible ? 'opacity-100 scale-100' : 'opacity-0 scale-95'
          }`}
        >

          {/* Background glow */}
          <div className="absolute inset-0 bg-gradient-to-tr from-[#D97706]/40 via-transparent to-black/20"></div>

          <div className="absolute top-0 right-0 w-96 h-96 bg-[#D97706]/30 rounded-full blur-3xl animate-pulse"></div>
          ...
          <div className="relative px-6 md:px-12 lg:px-16 py-12 md:py-16 grid lg:grid-cols-2 gap-8 items-center">
            ...
            <div className="space-y-6 text-white">
              ...
              <h2 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-bold leading-tight">
                Vehicle Health Estimate Intelligence
              </h2>
            ...
            <div className="bg-white rounded-2xl shadow-2xl p-5">
              ...
              <Button
                ...
                className="w-full mt-4 bg-[#D97706] hover:bg-[#B45309] text-white font-bold py-3"
              >
                Get Free Report
              </Button>

              <p className="text-xs text-gray-500 mt-3 text-center">
                Powered by Vehicle Health Estimate Data Engine
              </p>
