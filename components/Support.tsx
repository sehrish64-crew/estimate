...
const supportStats = [
  {
    ...
    color: 'from-[#D97706] to-[#B45309]',   // 🔴 changed
    iconColor: 'text-[#D97706]',           // 🔴 changed
    bgColor: 'bg-[#FAF5F0]',               // 🔴 light red bg
  },
  {
    icon: Clock,
    value: '24/7',
    label: 'always available',
    color: 'from-[#D97706] to-[#3a0000]',  // 🔴 changed
  ...
  },
  {
    ...
    color: 'from-[#D97706] to-[#8b0000]',  // 🔴 changed
    iconColor: 'text-[#D97706]',
    bgColor: 'bg-[#FAF5F0]',
  },
]
...
export default function Support() {
  ...
  return (
    ...
    >
      ...
      <div className="absolute top-20 left-20 w-64 h-64 bg-[#D97706]/20 rounded-full mix-blend-multiply filter blur-3xl opacity-30 animate-blob"></div>
      <div className="absolute bottom-20 right-20 w-64 h-64 bg-[#B45309]/20 rounded-full mix-blend-multiply filter blur-3xl opacity-30 animate-blob animation-delay-2000"></div>
