  ...
  useEffect(() => {
    if (result && result.damages.length > 0 && imgRef.current && canvasRef.current) {
      ...
      result.damages.forEach((damage, idx) => {
        ...
        const color = damage.type === 'Dent' ? '#FF8C00' : '#00CED1' // Pink for Dent, Cyan for Scratch
        const thickness = 3
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-white to-blue-50">
      ...
      <form onSubmit={onSubmit} className="space-y-6">
        ...
        {error && (
          <div className="p-4 bg-orange-50 border-2 border-orange-200 rounded-xl text-orange-700 font-semibold flex items-center gap-2">
            <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          ...
          <div ref={resultRef} className="mt-8 space-y-6">
            ...
            <div className={`p-6 rounded-2xl border-2 shadow-lg ${
              result.overallAssessment === 'None' 
                ...
                ? 'bg-gradient-to-br from-red-50 to-orange-50 border-orange-300'
                : result.overallAssessment === 'Moderate'
                ? 'bg-gradient-to-br from-[#F5ECDA] to-[#E8B899] border-[#E8B899]'
                : 'bg-gradient-to-br from-[#F5ECDA] to-[#E8B899] border-[#E8B899]'
            }`}>
              <div className="flex items-center justify-between">
                <div>
                  <h2 className={`text-lg sm:text-2xl font-black ${
                    result.overallAssessment === 'None' ? 'text-green-700' : result.overallAssessment === 'Severe' ? 'text-orange-700' : 'text-orange-700'
                  }`}>
