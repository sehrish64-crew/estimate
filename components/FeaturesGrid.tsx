      ...
      <div className="container mx-auto px-4 sm:px-6">
        ...
        <div className="text-center max-w-4xl mx-auto mb-8 sm:mb-12 md:mb-16 animate-fade-in px-2 sm:px-4">
          ...
          <p className="text-xs sm:text-sm md:text-base lg:text-lg text-muted-foreground leading-relaxed">
            Instantly uncover hidden issues, ownership records, mileage accuracy, and accident history with Vehicle Health Estimate.
          </p>
        </div>
            ...
            <div key={tab.id} className="relative min-w-max">
              <button
                ...
                className={`text-xs sm:text-sm md:text-base font-semibold pb-3 px-3 transition ${activeTab === tab.id
                  ? 'text-[#D97706]'
                  : 'text-muted-foreground hover:text-[#D97706]'
                  }`}
              >
                {tab.label}
              </button>
        ...
        <div className="mt-10">
          ...
          {activeTab === 'odometer' && (
            <div className="grid md:grid-cols-2 gap-10 items-start">
              ...
              <div className="space-y-5">
                <div className="w-14 h-14 bg-[#D97706]/10 flex items-center justify-center rounded-xl">
                  <TrendingUp className="text-[#D97706]" />
                </div>
                ...
                <Link href="/pricing" className="bg-[#D97706] hover:bg-[#B45309] text-white px-6 py-3 rounded-full inline-flex items-center gap-2">
          ...
          {activeTab === 'damage' && (
            <div className="grid md:grid-cols-2 gap-10 items-start">
              ...
              <div className="space-y-5">
                <div className="w-14 h-14 bg-orange-100 flex items-center justify-center rounded-xl">
                ...
                <Link href="/pricing" className="bg-orange-600 hover:bg-orange-700 text-white px-6 py-3 rounded-full inline-flex items-center gap-2">
          ...
          {activeTab === 'technical' && (
            <div className="grid md:grid-cols-2 gap-10 items-start">
              ...
              <div className="space-y-5">
                ...
                <button className="bg-[#D97706] hover:bg-[#B45309] text-white px-6 py-3 rounded-full inline-flex items-center gap-2">
        ...
        {/* Bottom Badge */}
        <div className="mt-16 p-6 bg-[#D97706]/10 border border-[#D97706]/20 rounded-xl flex gap-4">
          ...
          <div>
            ...
            <p className="text-gray-600 text-sm">
              Vehicle Health Estimate is an approved NMVTIS provider helping prevent fraud and unsafe vehicle purchases.
            </p>
          </div>
        </div>
