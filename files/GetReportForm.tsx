            ...
            <div>
              ...
              <div className="mb-2">
                <div className="inline-flex items-center bg-gray-100 rounded-full p-1 gap-1">
                  <button type="button" onClick={() => setVehicleIdType('vin')} className={`flex items-center gap-2 px-3 py-1 rounded-full transition-all ${vehicleIdType === 'vin' ? 'bg-[#D97706] text-white shadow' : 'text-black hover:bg-gray-200'}`}>
              ...
              <div className="flex gap-3">
                {packages.map((pkg) => (
                  <button
                    ...
                    className={`flex-1 p-3 rounded-lg border transition-all text-left ${selectedPackage === pkg.id ? 'bg-[#D97706] text-white border-transparent shadow' : 'bg-white border-gray-200 hover:shadow-sm'}`}
                  >
