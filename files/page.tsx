    ...
    <div className="min-h-screen bg-gray-50 p-8">
      <div className="max-w-2xl mx-auto bg-white rounded-lg shadow-lg p-6">
        ...
        <div className="space-y-4 mb-8">
          ...
          <div id="paddle-status" className="bg-[#F5ECDA] border border-[#E8B899] rounded p-4">
            <h3 className="font-semibold text-[#B45309] mb-2">Paddle Status:</h3>
          ...
          (function() {
            ...
            function updateStatus(msg, type = 'info') {
              ...
              const colors = {
                ...
                error: 'text-orange-900 bg-orange-50 border-orange-200',
                warning: 'text-[#B45309] bg-[#F5ECDA] border-[#E8B899]',
