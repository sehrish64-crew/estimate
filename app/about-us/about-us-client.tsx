...
export default function AboutUsClient() {
  ...
  return (
    <div className="bg-white">
      ...
      {/* HERO */}
      <div className="relative overflow-hidden bg-gradient-to-br from-[#D97706]/10 via-white to-gray-50">

        <div className="absolute inset-0 bg-[radial-gradient(circle_at_top,#D9770615,transparent_60%)]" />

        <div className="container mx-auto px-4 py-20 text-center max-w-4xl">

          <span className="inline-flex items-center gap-2 px-5 py-2 rounded-full bg-[#D97706]/10 text-[#D97706] font-semibold border border-[#D97706]/20">
            <Shield size={16} /> About Vehicle Health Estimate
          </span>

          <h1 className="text-4xl md:text-6xl font-extrabold mt-6 leading-tight">
            Driving <span className="text-[#D97706]">Trust</span> Through Vehicle Data
          </h1>

          <p className="text-gray-600 mt-5 text-lg">
            Vehicle Health Estimate is a digital vehicle history platform built to help people make safer,
      ...
      <div className="container mx-auto px-4 py-14">
        <div className="grid grid-cols-2 md:grid-cols-4 gap-5">
          ...
          {stats.map((s, i) => (
            <div
              key={i}
              className="group bg-white border border-gray-200 rounded-2xl p-6 text-center shadow-sm hover:shadow-xl hover:border-[#D97706]/30 transition-all"
            >
              <div className="w-12 h-12 mx-auto rounded-xl bg-[#D97706]/10 flex items-center justify-center group-hover:scale-110 transition">
                <s.icon className="text-[#D97706]" />
              </div>
        ...
        <div className="container mx-auto px-4 grid lg:grid-cols-2 gap-10 items-center">
          ...
          <div className="space-y-5">
            ...
            <h2 className="text-3xl md:text-5xl font-bold">
              Why We Built <span className="text-[#D97706]">Vehicle Health Estimate</span>
            </h2>

            <p className="text-gray-600 leading-relaxed">
              Buying a used car can be risky. Hidden accidents, mileage fraud, and incomplete history
              often lead to financial loss. We created Vehicle Health Estimate to solve this problem.
            </p>
            ...
            <div className="flex gap-4 pt-2">
              <div className="flex items-center gap-2 text-gray-700">
                <Award className="text-[#D97706]" /> Trusted Reports
              </div>
              <div className="flex items-center gap-2 text-gray-700">
                <Heart className="text-[#D97706]" /> User Focused
              </div>
            </div>
          ...
          <div className="relative">
            <div className="absolute -inset-4 bg-[#D97706]/10 rounded-3xl blur-2xl"></div>
      ...
      <div className="container mx-auto px-4 py-20">
        ...
        <div className="text-center mb-12">
          <h2 className="text-4xl font-bold">
            Our <span className="text-[#D97706]">Core Values</span>
          </h2>
        ...
        <div className="grid md:grid-cols-2 gap-6">
          ...
          {values.map((v, i) => (
            <div
              key={i}
              className="p-6 rounded-2xl border bg-white hover:shadow-xl hover:border-[#D97706]/30 transition"
            >
              <div className="w-12 h-12 rounded-xl bg-[#D97706]/10 flex items-center justify-center mb-4">
                <v.icon className="text-[#D97706]" />
              </div>
      ...
      {/* CTA */}
      <div className="bg-gradient-to-r from-[#D97706] to-black py-16 text-center text-white">
        ...
        <button className="mt-6 bg-white text-[#D97706] hover:bg-gray-200 font-bold px-8 py-3 rounded-xl">
          Get Report Now
        </button>
