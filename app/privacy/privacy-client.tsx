    ...
    <div className="bg-white">
      <div className="relative container mx-auto px-6 py-20">
        ...
        <div className="mt-10 space-y-8 max-w-3xl mx-auto text-gray-700">
          <section>
            <p className="text-lg font-semibold text-gray-900 mb-4">This Privacy Policy explains how **Nexlify Labs LTD** ("we", "our", "us"), operating through **Vehicle Health Estimate**, collects, uses, and protects your personal information.</p>
          ...
          <section>
            ...
            <div className="mt-4 bg-blue-50 p-4 rounded-lg border border-blue-200 space-y-2">
              ...
              <p className="text-gray-700"><strong>Website:</strong> <a href="https://VehicleHealthEstimate.com" className="text-blue-600 hover:underline">https://VehicleHealthEstimate.com</a></p>
            </div>
