  ...
  return (
    <>
      <div ref={sectionRef} className="relative bg-gradient-to-b from-white via-red-50/30 to-white overflow-hidden">
        ...
        {/* Glow Background */}
        <div className="absolute top-0 left-1/2 -translate-x-1/2 w-[600px] h-[600px] bg-orange-200/30 blur-3xl rounded-full"></div>
              ...
              >
                ...
                <div className="p-8 text-center">
                  ...
                  <button
                    ...
                    ${plan.popular ? 'bg-blue-600 hover:bg-blue-700' : 'bg-[#D97706] hover:bg-[#B45309]'}`}
                  >
                    {plan.buttonText}
                  </button>
