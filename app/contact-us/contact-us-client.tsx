...
export default function ContactUsClient() {
  ...
  return (
    <div className="relative overflow-hidden bg-white">
      ...
      {/* Background */}
      <div className="absolute inset-0 bg-gradient-to-br from-[#D97706]/10 via-white to-[#D97706]/5"></div>

      <div className="absolute -top-20 left-10 w-96 h-96 bg-[#D97706]/20 rounded-full blur-3xl"></div>
      <div className="absolute bottom-0 right-10 w-96 h-96 bg-orange-200/40 rounded-full blur-3xl"></div>

      <div ref={heroRef} className="relative container mx-auto px-4 py-16">

        {/* HEADER */}
        <div className="text-center max-w-3xl mx-auto mb-14">
          <div className="inline-flex items-center gap-2 px-5 py-2 bg-[#D97706]/10 border border-[#D97706]/20 rounded-full text-[#D97706] font-semibold">
            <MessageCircle size={16} />
            Get in Touch
          </div>

          <h1 className="text-4xl md:text-6xl font-extrabold mt-6 text-gray-900">
            Contact <span className="text-[#D97706]">Vehicle Health Estimate</span>
          </h1>
        ...
        <div className="max-w-4xl mx-auto bg-white rounded-3xl shadow-2xl border border-gray-100 overflow-hidden">
          ...
          <div className="bg-gradient-to-r from-[#D97706] to-black text-white p-6 md:p-10">
          ...
          <form onSubmit={handleSubmit} className="p-6 md:p-10 space-y-5">
            ...
            {submitError && (
              <p className="text-orange-600">{submitError}</p>
            )}

            <Button
              type="submit"
              disabled={isSubmitting}
              className="w-full bg-[#D97706] hover:bg-black text-white py-3 rounded-xl text-lg font-semibold transition-all"
            >
