    ...
    <div className="flex min-h-screen bg-gray-50 overflow-x-hidden">
      ...
      {!isLoginRoute && (
        ...
        <div className="flex items-center justify-between h-16 px-6 border-b border-gray-200">
          <Link href="/admin/dashboard" className="flex items-center gap-2">\n            <img src="/logo.png" alt="Vehicle Health Estimate" className="h-8 w-auto" />\n          </Link>
        ...
        <nav className="flex-1 p-3 sm:p-4 space-y-1 overflow-y-auto">
          ...
          >
            ...
            {counts.orders > 0 && (
              <span className="ml-auto inline-flex items-center justify-center px-2 py-0.5 rounded-full bg-orange-600 text-white text-xs font-semibold flex-shrink-0">{counts.orders}</span>
            )}
          </Link>
          ...
          >
            ...
            {t('admin_reviews')}
            {counts.reviews > 0 && (
              <span className="ml-auto inline-flex items-center justify-center px-2 py-0.5 rounded-full bg-orange-600 text-white text-xs font-semibold">{counts.reviews}</span>
            )}
          </Link>
          ...
          >
            ...
            {t('nav_contact')}
            {counts.contacts > 0 && (
              <span className="ml-auto inline-flex items-center justify-center px-2 py-0.5 rounded-full bg-orange-600 text-white text-xs font-semibold">{counts.contacts}</span>
            )}
          </Link>
          ...
          >
            ...
            {counts.registrations > 0 && (
              <span className="ml-auto inline-flex items-center justify-center px-2 py-0.5 rounded-full bg-orange-600 text-white text-xs font-semibold flex-shrink-0">{counts.registrations}</span>
            )}
          </Link>
        ...
        <div className="p-4 border-t border-gray-200">
          <button
            ...
            className="flex w-full items-center gap-3 px-4 py-3 text-sm font-medium text-orange-600 rounded-lg hover:bg-orange-50 transition-colors"
          >
