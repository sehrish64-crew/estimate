...
const getPaymentStatusBadge = (status: string) => {
  switch (status) {
    ...
    case 'pending':
      return <Badge className="bg-[#E8B899] text-[#B45309] hover:bg-[#E8B899]">Pending</Badge>
    case 'failed':
      return <Badge className="bg-orange-100 text-orange-800 hover:bg-orange-100">Failed</Badge>
    default:
...
function OrderCard({ order, onStatusChange, onDelete, onView, onEdit }: {
  ...
  const getStatusColor = (s: string) => {
    switch (s) {
      ...
      case 'pending':
        return 'bg-[#E8B899] text-[#B45309] border-[#E8B899]'
      case 'cancelled':
