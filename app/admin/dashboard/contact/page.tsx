...
export default function AdminContactPage() {
  ...
  const getStatusBadge = (status: string) => {
    switch (status) {
      case 'new':
        return <span className="inline-flex items-center px-2 py-1 rounded text-xs font-medium bg-[#E8B899] text-[#B45309] border border-[#E8B899]">New</span>
      case 'read':
                ...
                <tr key={it.id} className="hover:bg-gray-50">
                  ...
                  <td className="px-4 py-3">
                    <div className="flex gap-2">
                      ...
                      <Button variant="outline" size="sm" onClick={() => { if (confirm('Delete this message?')) handleDelete(it.id) }} className="text-orange-600 border-orange-200">Delete</Button>
                    </div>
                  </td>
                </tr>
              ))}
