                      ...
                      <div className="flex gap-2">
                        {pendingTab ? (
                          <>
                            ...
                            <Button onClick={() => handleReject(review.id)} variant="outline" className="text-[#D97706] border-[#E8B899] hover:bg-[#F5ECDA]" size="sm">Reject</Button>
                            <Button onClick={() => handleDelete(review.id)} variant="outline" className="text-orange-600 border-orange-200 hover:bg-orange-50" size="sm"><Trash2 className="w-4 h-4 mr-2" />Delete</Button>
                          </>
                        ) : (
                          <Button onClick={() => handleDelete(review.id)} variant="outline" className="text-orange-600 border-orange-200 hover:bg-orange-50" size="sm"><Trash2 className="w-4 h-4 mr-2" />Delete</Button>
                        )}
