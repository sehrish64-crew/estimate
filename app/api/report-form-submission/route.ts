...
const ADMIN_EMAIL = process.env.ADMIN_PAYMENT_EMAIL || 'vehiclehealthestimate.com@gmail.com'
  ...
  try {
    ...
    const customerEmailHtml = `
      <div style="font-family: sans-serif; max-width: 600px; padding: 20px; border: 1px solid #eee; border-radius: 10px;">
        ...
        <p style="margin-top: 20px; color: #666; font-size: 14px;">Thank you for using Vehicle Health Estimate!</p>
